...
## 0. Current state — the authoritative snapshot (updated 2026-09-13)
...
Four artifacts, one chain, and they are not interchangeable.
    ...
    docs/spec-source/Ember_v0.9.6_Hardened_5.md         immutable immediate predecessor
    docs/spec-source/Ember_v0.9.6_Hardened_6.md         current frozen development target; NOT normative until explicitly adopted
...
1. `docs/spec-source/ember-spec.md` and frozen H6 — especially H1/H5's canonical
