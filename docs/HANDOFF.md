...
| Latest continuation checkpoint | `b0dad81` supports inherited and declared class defaults in physical base-first order for supported derived constructors; the full workspace regression and repository gates pass |
