...
Four artifacts, one chain, and they are not interchangeable.
    ...
    docs/spec-source/Ember_v0.9.5_Hardened_9.md         frozen development target; NOT normative until explicitly adopted
                                                        (H4 through H8 are immutable predecessor records)
...
0.25 is the current H9 target and Arena implementation record; where status or
pickup wording below differs, §0.25 governs.
