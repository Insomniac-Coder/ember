...
## 0. Current state — the authoritative snapshot (updated 2026-09-14)
...
Four artifacts, one chain, and they are not interchangeable.
    ...
    docs/spec-source/Ember_v0.9.7_Hardened_1.md         current frozen development target; NOT normative until explicitly adopted
...
| Latest continuation checkpoint | `bddb8d1` records the pushed canonical Arena storage-fact and storage-survival-constraint consumers; the final workspace regression and six repository gates pass |
