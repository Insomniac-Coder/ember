...
**Version:** 0.9.9_Hardened_4
**Supersedes:** 0.9.9_Hardened_3, 0.9.9_Hardened_2, 0.9.9_Hardened_1, 0.9.8_Hardened_3 (development target) and 0.8.5_Hardened_1 (adopted). This document is
...
* `[TYP-23]` *(changed in 0.9.9)* Inference is local to a function body and bidirectional. Function
  ...
  types flow into literals, lambdas, `None`, `Ok(…)`, `Err(…)` and generic calls. A lambda with
  unannotated parameters and no expected callable type is `E2061`. Within one expression, untyped
