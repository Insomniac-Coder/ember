...
**Version:** 0.9.7_Hardened_3
**Immediate predecessor:** 0.9.7_Hardened_2 (immutable; preserved as the diff base)
**Status:** Frozen development target. Implementation and conformance evidence is **not** claimed; normative repository adoption still requires the recorded adoption gates.
    ...
    Specification    frozen for this target — 873 rules, every one carrying a change-log
                     row. ODR-016 is closed here, and the two gaps Hardened_2 reported
                     beside it were never gaps and are withdrawn (H3.1). 13 rule ids are
...
`0.9.7_Hardened_3` because it changes no rule's meaning.**
