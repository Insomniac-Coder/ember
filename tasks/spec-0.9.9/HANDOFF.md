...
* **LOCATION (2026-09-23):** this folder is committed on `main` (`Code/ember/tasks/spec-0.9.9/`); build hardenings to `Code/ember/docs/spec-source/`. H4 is the latest (ODR-023); `parts/` is the working source for H5, and `parts-h4/` is frozen.
