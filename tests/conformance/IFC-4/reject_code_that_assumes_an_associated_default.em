...
# interface's own default body may take `Out` to be `Self`.
...
interface Combine:
    ...
    fn twice(self) -> Self:
        return self.combine(self) #$ error[E2020]: expected `Self`, found

fn assume[T: Combine](a: T, b: T) -> T:
    return a.combine(b) #$ error[E2020]: expected `T`, found
