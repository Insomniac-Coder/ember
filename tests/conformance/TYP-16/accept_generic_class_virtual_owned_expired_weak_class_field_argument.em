...
# An owned weak argument crossing a generic virtual call remains only a control
# block observer after its class field's former strong target has expired. The
# derived override must take the None path and release its own argument copy.
class Token:
    value: i32
