...
# A borrowed Weak[Shared[Token]] argument crosses a composed dynamic box whose
# concrete class inherits its state from a generic base. The base-typed payload
# remains shared by both ordered interface slots.
interface Observe:
