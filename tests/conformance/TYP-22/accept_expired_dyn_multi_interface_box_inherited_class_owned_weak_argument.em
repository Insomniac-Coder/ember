#$ test: run-pass
#$ rules: TYP-16, TYP-22, IFC-1, CLS-4, CLS-7, DRP-6, OWN-2, HEAP-3, HEAP-4, HEAP-5, HEAP-6, HEAP-7, WK-11, WK-12, WK-13, TST-26
...
# An owned weak argument through an inherited Pixel dynamic box receives and
# destroys its independent observer after expiry; the sibling slot remains
# callable and updates the base-class payload.
interface Observe:
