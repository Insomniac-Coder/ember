...
# An owned weak argument crossing a composed dynamic box is copied for an
# inherited, non-generic class implementation, while the second slot updates
# the same Pixel payload.
interface Observe:
