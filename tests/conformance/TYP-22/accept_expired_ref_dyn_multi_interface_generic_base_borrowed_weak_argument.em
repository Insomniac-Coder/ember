...
# A borrowed weak argument through a ref dyn composed carrier takes None after
# expiry even when the concrete class inherits its state from a generic base.
interface Observe:
...
fn main():
    ...
    println(inspect(ref holder, expired()))
