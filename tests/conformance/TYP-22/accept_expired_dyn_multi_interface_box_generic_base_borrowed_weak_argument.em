...
# A borrowed weak argument through a composed dynamic box with generic-base
# state takes None after the Shared target expires. The inherited payload stays
# usable through the second interface slot.
interface Observe:
